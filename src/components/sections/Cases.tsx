...
export default function Cases() {
  return (
    <section id="projetos" className="relative bg-white py-16 sm:py-20 md:py-28 lg:py-40 overflow-hidden">
          ...
          {cases.map((c, i) => (
            <AnimateOnScroll key={c.client} delay={i * 0.1} className={c.span}>
              <motion.div
                ...
                className="group relative rounded-2xl overflow-hidden cursor-default h-72 sm:h-80 md:h-95"
              >
                {/* Photo */}
                <Image
                  src={c.image}
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <motion.div
                ...
                className="relative rounded-xl overflow-hidden h-48 sm:h-40 md:h-44"
              >
                <Image
                  src={src}
                  alt=""
